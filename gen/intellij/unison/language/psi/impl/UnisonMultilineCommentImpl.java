...
public class UnisonMultilineCommentImpl extends ASTWrapperPsiElement implements UnisonMultilineComment {

  public UnisonMultilineCommentImpl(@NotNull ASTNode node) {
    super(node);
  }
