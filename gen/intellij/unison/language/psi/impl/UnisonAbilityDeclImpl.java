...
public class UnisonAbilityDeclImpl extends ASTWrapperPsiElement implements UnisonAbilityDecl {

  public UnisonAbilityDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UnisonVisitor visitor) {
    visitor.visitAbilityDecl(this);
  }
