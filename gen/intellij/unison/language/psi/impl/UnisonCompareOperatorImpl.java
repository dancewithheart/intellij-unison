...
public class UnisonCompareOperatorImpl extends ASTWrapperPsiElement implements UnisonCompareOperator {

  public UnisonCompareOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
