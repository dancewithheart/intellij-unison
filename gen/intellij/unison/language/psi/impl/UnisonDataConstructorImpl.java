...
public class UnisonDataConstructorImpl extends ASTWrapperPsiElement implements UnisonDataConstructor {

  public UnisonDataConstructorImpl(@NotNull ASTNode node) {
    super(node);
  }
